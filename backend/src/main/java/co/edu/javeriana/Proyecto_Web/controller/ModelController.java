...
public class ModelController {
    ...
    public ModelDTO view(@Parameter(description = "ID of the model to retrieve", example = "1")
    ...
    public ModelDTO create(@Parameter(description = "Model data to save")
    ...
    public ModelDTO update(@Parameter(description = "ID of the model to update", example = "1")
        @PathVariable Long id, @Parameter(description = "Updated model data")
        @RequestBody ModelDTO dto) {
        dto.setId(id);
        modelService.save(dto);
        return dto;
    ...
    public void delete(@Parameter(description = "ID of the model to delete", example = "1")
        @PathVariable Long id) {
    ...
    public List<ModelDTO> search(@Parameter(description = "Text to search in model names", example = "example")
