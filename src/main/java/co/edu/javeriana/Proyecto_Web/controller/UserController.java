...
public class UserController {
    ...
    public UserDTO viewUser(@Parameter(description = "ID of the user to retrieve", example = "1")
    ...
    public UserDTO editUserData(@Parameter(description = "ID of the user to edit", example = "1")
        @PathVariable("id") Long id) {
        return userService.searchUser(id).orElseThrow();
    }
    ...
    public UserDTO createUser(@Parameter(description = "User data to save")
    ...
    public UserDTO updateUser(@Parameter(description = "Updated user data")
        @RequestBody UserDTO dto) {
    ...
    public void deleteUser(@Parameter(description = "ID of the user to delete", example = "1")
        @PathVariable("id") Long id) {
    ...
    public List<UserDTO> searchUsers(@Parameter(description = "Text to search in user names", example = "example")
